...
# lipsa - ruleaza intai:
#   xattr -d com.apple.quarantine Dezinstalare_CursorPro.command
#   chmod +x Dezinstalare_CursorPro.command
#
...
#
# NOTA 3: stergerea /Applications/CursorPro.app poate cere parola de
...
BUNDLE_ID="com.gordasgdc.cursorpro"
APP_PATH="/Applications/CursorPro.app"

echo "=================================================="
echo " CursorPro GDC — Dezinstalare & Curatare completa"
echo "=================================================="
echo ""

# ---- Pasul 1: Oprire procese -------------------------------------------
echo "[1/3] Opresc orice instanta CursorPro ramasa in fundal..."
pkill -x "CursorPro" 2>/dev/null
pkill -f "CursorPro.app" 2>/dev/null
sleep 1
echo "[+] Procese oprite."
echo ""
...
remove_if_exists "$HOME/Library/Application Support/CursorPro"
...
remove_if_exists "$HOME/Library/Logs/CursorPro"
...
echo " Poti reinstala CursorPro GDC de la zero acum."
echo "=================================================="
echo ""
