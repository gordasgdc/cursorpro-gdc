...
/// din `Localization.swift`. Fail-open: fără conexiune sau `productID`
/// lipsă, se folosește `fallbackBasePrice` (9 €, valoarea hardcodată
/// anterior).
final class PricingChecker: ObservableObject {
    ...
    private static let productID = "cursorpro"
    static let fallbackBasePrice: Double = 9
